...
object SlickBuild extends Build {
  ...
  val slickVersion = "3.1.0-PURE"
  val slickExtensionsVersion = "3.1.0-PURE" // Slick extensions version for links in the manual
  val binaryCompatSlickVersion = "3.1.0-PURE" // Slick base version for binary compatibility checks
